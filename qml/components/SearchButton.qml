...
//        }
        ...
        //icon.source: searchButton.isActive ? "image://theme/toolkit_input-search?" + LocalTheme.highlightColor : "image://theme/toolkit_input-search?" + LocalTheme.primaryColor
        anchors {
    ...
    Label {
        ...
        color: searchButton.isActive ? LocalTheme.highlightColor : LocalTheme.primaryColor

...
//        }
        ...
        //icon.source: messagesButton.isActive ? "image://theme/icon-m-mail?" + LocalTheme.highlightColor : "image://theme/icon-m-mail?" + LocalTheme.primaryColor
        anchors {
    ...
    Label {
        ...
        color: messagesButton.isActive ? LocalTheme.highlightColor : LocalTheme.primaryColor
